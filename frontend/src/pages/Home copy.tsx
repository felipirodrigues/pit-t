...
import Mapa2 from '../images/mapa3.jpg';
    ...
    <div className="fixed inset-0 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        <Globe
          ...
          // Configuração do Globe - usando estilo personalizado
          ...
          // Estilo personalizado do globo
          globeMaterial={new THREE.MeshPhongMaterial({
            //map: new THREE.TextureLoader().load('//cdn.jsdelivr.net/npm/three-globe/example/img/earth-blue-marble.jpg'),
            map: new THREE.TextureLoader().load(Mapa2),
            //map: new THREE.TextureLoader().load('https://eoimages.gsfc.nasa.gov/images/imagerecords/73000/73909/world.topo.bathy.200412.3x21600x10800.jpg'),
            //map: new THREE.TextureLoader().load(Mapa2),
            bumpMap: new THREE.TextureLoader().load('//cdn.jsdelivr.net/npm/three-globe/example/img/earth-topology.png'),
            bumpScale: 0.3,
            //specularMap: new THREE.TextureLoader().load('//unpkg.com/three-globe/example/img/earth-specular.jpg'),
